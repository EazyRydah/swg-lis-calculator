 ...
 * PHP version 7.0
 */
class Calculation extends \Core\Model
{
    ...
    /**
     * Calculate new Calculation with the current propertxy values 
     * 
     * @return void
    * */ 
    ...
    /**
     * Validate the calculation input, adding validation errors to errors array
     * 
     * @return void
    */  
